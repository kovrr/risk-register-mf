  ...
  mock() {
    ...
    Array.from(
      ...
      [
        ...
        cy.intercept(
          'GET',
          `/api/risk-register/scenarios?page=${page}&size=10&sort_by=${column}&sort_order=desc`,
          {
            body,
          },
        ...
        cy.intercept(
          'GET',
          `/api/risk-register/scenarios?page=${page}&size=10&sort_by=${column}&sort_order=asc`,
          {
            body,
          },
