...
export function ImpactDistributionCard({
  distribution,
  currency,
  averageLoss,
  ...
  return (
    <Card>
      <div className='max-h-[368px] space-y-6'>
        <div className='flex flex-col gap-2'>
          <h2 className='text-[17px] font-bold'>{t('impactDistribution')}</h2>
          <p className='max-w-[600px] text-[14px] font-normal text-text-base-secondary'>
